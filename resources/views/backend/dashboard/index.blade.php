...
<div class="col-xl-3 col-md-6 mb-4">
    <a href="{{route('costume.index')}}" style="text-decoration:none;">
    <div class="card border-left-primary shadow-sm h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Kostum Tersedia</div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{$costume->where('status','tersedia')->get()->count()}} / {{$costume->get()->count()}}</div>
                </div>
                <div class="col-auto">
